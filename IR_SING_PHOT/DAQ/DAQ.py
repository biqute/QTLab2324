...
#===================================================================================================================================
    ...
    def config_trigger(self):
        if(self._trigger_type == ni.TriggerType.IMMEDIATE):
            self._session.configure_trigger_immediate()
        elif (self._trigger_type == ni.TriggerType.DIGITAL):
        ...
        elif (self._trigger_type == ni.TriggerType.EDGE):
        ...
        elif (self._trigger_type == ni.TriggerType.SOFTWARE):
            self._session.configure_trigger_software(self._trigger_dic['holdoff'], self._trigger_dic['delay'])
        elif (self._trigger_type == ni.TriggerType.WINDOW):
            self._session.configure_trigger_window(self._trigger_dic['trigger_source'], self._trigger_dic['low_level'], self._trigger_dic['high_level'], self._trigger_dic['window_mode'], self._trigger_dic['trigger_coupling'], holdoff=self._trigger_dic['holdoff'], delay=self._trigger_dic['delay'])
