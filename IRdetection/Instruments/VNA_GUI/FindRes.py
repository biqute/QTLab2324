...
class Ui_FindRes(object):
    def setupUi(self, Parameters):
        ...
        self.gridLayout.addWidget(self.start_pushButton, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.points_pushButton, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.start_lcd, 3, 0, 1, 1)
        self.stop_pushButton = QtWidgets.QPushButton(self.gridLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.stop_lcd = QtWidgets.QLCDNumber(self.gridLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.stop_lcd.sizePolicy().hasHeightForWidth())
        self.stop_lcd.setSizePolicy(sizePolicy)
        self.stop_lcd.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.stop_lcd.setFrameShadow(QtWidgets.QFrame.Plain)
        self.stop_lcd.setLineWidth(3)
        self.stop_lcd.setObjectName("stop_lcd")
        self.gridLayout.addWidget(self.stop_lcd, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.points_lcd, 2, 0, 1, 1)
        ...
        self.power_lcd.setDigitCount(5)
        self.power_lcd.setMode(QtWidgets.QLCDNumber.Dec)
        ...
        self.gridLayout.addWidget(self.IFBW_pushButton, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.IFBW_lcd, 1, 0, 1, 1)
        ...
        self.stop_pushButton.clicked.connect(self.change_STOP)
    ...
    def retranslateUi(self, Parameters):
        ...
        vna = hp.HP8753E()
        vna.set_save_path("C:\\Users\\kid\\SynologyDrive\\Lab2023\\KIDs\\QTLab2324\\IRdetection\\Instruments\\Test_data\\FindRes\\")
        Parameters.setWindowTitle(_translate("Parameters", "Parameters"))
        self.window_desc.setText(_translate("Parameters", "FIND RESONANCES"))
        ...
        self.stop_pushButton.setText(_translate("Parameters", "Change Stop"))
    ...
    def reset(self):
        ...
        self.stop_lcd.display(vna.get_stop())
