...
def setup_logger(log_file=r'C:\Users\ricca\Desktop\MAGISTRALE\QTLab2324\IRdetection\2o raff\Logs\psweep.log', level=logging.DEBUG):
    """
...
num = 0
powers = np.arange(-80,-40,-10)
res = [5.3465, 5.5757, 5.6748, 5.98126]

for pw in powers:
    vna.set_save_path(r'C:\Users\ricca\Desktop\MAGISTRALE\QTLab2324\IRdetection\2o raff\Data\Psweep\P_'+str(pw))
    vna.set_power(pw)
    logger.debug('Power is : '+str(pw))
    for r in res:
        num += 1
        try:
            vna.set_center(r)
