...
ACQUISITION_CONFIG = { 
    ...
    'cont_acq_conf': {
        'path'              : path,
        'file_name'         : name,
        'sample_rate'       : 250e6 ,  # rate of points sampling of PXIe-5170R in Hz
        'total_acq_time'    : 5   ,  # total acquisition time in seconds
        'total_samples'     : int(sample_rate*pulse_period),  # total number of points sampled
